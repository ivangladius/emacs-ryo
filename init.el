...
=======
   '(electric-pair-mode electric-pair rainbow-delimiters rainbow-delemiters paredit lsp-ui projectile lsp-java lsp-treemacs smartparens lsp-ivy lsp-pyright lsp-mode which-key-mode dap-mode company-mode elgot magit sly-macrostep sly company doom-themes smex gruvbox-theme ace-window counsel which-key use-package ryo-modal))
>>>>>>> d21b38c (new)
