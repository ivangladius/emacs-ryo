...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit sly-macrostep sly company doom-themes smex gruvbox-theme ace-window counsel which-key use-package ryo-modal))
...
(custom-set-faces
 ...
 '(mode-line ((t (:background "#e1d8b3" :foreground "dark red" :box nil))))
 '(mode-line-inactive ((t (:foreground "#a38780" :box nil)))))
